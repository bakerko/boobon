...
<main class="container">
    ...
    <form method="post" action="/home/product_change/1" enctype="multipart/form-data">
        ...
        <div class="photos">
            ...
            <p class="choice">Название</p><input type="text" name="name" value="<?php echo $product->name;?>">
