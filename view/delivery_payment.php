...
Коробка с шарами помещается в автомобиль универсал и более крупные авто, при условии разложенного заднего сидения и пустого багажника
    ...
    <ul class="padding big_container">
        ...
        <li class="noMargin_flexbox bordered">
            <p>Все заказы сделанные онлайн, надуваются исключительно по предоплате. Предоплата на заказ составляет 1000 грн, в случае если сумма заказа меньше 1000 грн. На заказы сумма которых превышает 1000 грн, предоплата составит не менее 20%.
            </p>
        </li>
        ...
        <li class="noMargin_flexbox bordered">
            <p>
                Оплатить заказ банковской картой возможно в нашем магазине по адресу улица Владимира Мономаха 5, с помощью терминала. 
            </p>
        </li>    
