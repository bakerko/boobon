        ...
        <div class="product_description_top">
            ...
            <div class="noMargin_flexbox center btn">
                ...
                ?>
                    ...
                    <button onclick="add_product_from_mix_js('<?php echo $product->id;?>'); show_popup('<?php echo $product->name;?>');" class="button cart_button" style="width:150px;"><img class="button_icon invert_color" src="/images/Cart-1.png"/><div style="margin-left:-11px;">Раздельно</div></button>
            </div>
            <hr>
            <div>
