...
<main class="container">
    ...
    <ul class="big_container">
        <li class="noMargin_flexbox bordered">
                <span class="delivery"><i style="font-size: 30pt;" class="fas fa-shield-alt table_icon"></i><b>404</b></span>
        </li>

        <li class="noMargin_flexbox bordered"><p>Извините, что-то пошло не так. Такой страницы не найдено.</p></li>
