...
<main class="container">
    ...
    <ul class="big_container">
        ...
        <li class="noMargin_flexbox bordered">
            <p>Да, Вы можете воспользоваться услугой самовывоза из нашего магазина по адресу ул. Троицкая 16 и сэкономить на доставке. О заказе следует уведомлять за 2-3 часа до приезда, чтобы его успели подготовить.
        </p></li>
