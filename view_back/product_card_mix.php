    ...
    <section class="product_description">
        <div class="product_description_top">
            ...
            <div class="noMargin_flexbox center btn">
                ...
                <a href="/home/cart_add_product/<?php echo $product->id;?>/<?php echo $product->price;?>/0"><button class="button buy_button no_margin" style="width:150px;"><img class="button_icon invert_color" src="/images/Cart-1.png"/> Одним товаром
                </button></a>
                <a href="/home/cart_add_products_from_mix/<?php echo $product->id;?>"><button class="button buy_button no_margin" style="width:150px;"><img class="button_icon invert_color" src="/images/Cart-1.png"/> Раздельно
                </button></a>
            </div>
            <hr>
            <div>
